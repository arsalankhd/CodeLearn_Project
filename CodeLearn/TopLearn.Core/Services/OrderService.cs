...
namespace CodeLearn.Core.Services
{
    public class OrderService : IOrderService
    {
        ...
        public OrderService(CodeLearnContext context, IUserService userService, ICourseService courseService)
        {
            _context = context;
        ...
        public bool FinallyOrder(string userName, int orderId)
        {
            ...
            var order = _context.Orders.Include(o => o.OrderDetails).ThenInclude(d => d.Course)
        ...
        {
            int userId = _userService.GetUserIdByUserName(userName);
            return _context.UserCourses.Any(o => o.UserId == userId && o.CourseId == courseId);
        }
